  ...
  <section class="text-center flex flex-col items-center justify-center">
    ...
    <div class="flex flex-col items-center w-full pt-[60px] bg-top bg-no-repeat bg-[length:100%_630px]">
            ...
            <h3 class="text-[#22242c] text-[25px] font-normal leading-[0.53rem] mt-[21px] pt-[0] text-center">跨境出海私域营销一体化解决方案</h3>
                    ...
                    <!-- 下载方式 -->
            <div class="flex justify-between gap-[80px] mt-[80px]">
                <article class="flex flex-col items-center relative w-[210px] min-h-[290px] pt-[40px] border border-[#f3f3f3] rounded-[8px] shadow-[0_10px_15px_#6b6b6b0a,0_5px_20px_#e3e3e30d] box-border first:bg-gradient-to-b first:from-white first:from-[166px] first:via-white first:to-[#f2fff1]">
                        <img src="/ipx/index-btn-icon.webp" width="36" height="36" class="absolute right-[6px] top-[6px]"/>
                        <img src="/ipx/download-windows.png" width="48" height="48"/>
                        <h4 class="text-[#22242c] text-[16px] font-medium leading-[22px] mt-[16px] mb-[74px] text-center">Windows 版</h4>
                        <button class="bg-[#22242c] text-[#fff] rounded-[8px] text-[16px] mb-[12px] min-h-[40px] w-[150px]">下载</button>
                        <p class="text-[12px] cursor-pointer underline">低版本下载</p>
                </article>
                 <article class="flex flex-col items-center relative w-[210px] min-h-[290px] pt-[40px] border border-[#f3f3f3] rounded-[8px] shadow-[0_10px_15px_#6b6b6b0a,0_5px_20px_#e3e3e30d] box-border [&:nth-child(2)]:bg-gradient-to-b [&:nth-child(2)]:from-white [&:nth-child(2)]:from-[166px] [&:nth-child(2)]:via-white [&:nth-child(2)]:to-[#edf9fe]">
                        <img src="/ipx/index-btn-icon.webp" width="36" height="36" class="absolute right-[6px] top-[6px]"/>
                        <img src="/ipx/download-windows.png" width="48" height="48"/>
                        <h4 class="text-[#22242c] text-[16px] font-medium leading-[22px] mt-[16px] mb-[74px] text-center">Windows 版</h4>
                        <button class="bg-[#22242c] text-[#fff] rounded-[8px] text-[16px] mb-[12px] min-h-[40px] w-[150px]">下载</button>
                ...
                <article class="flex flex-col items-center relative w-[210px] min-h-[290px] pt-[40px] border border-[#f3f3f3] rounded-[8px] shadow-[0_10px_15px_#6b6b6b0a,0_5px_20px_#e3e3e30d] box-border last:bg-gradient-to-b last:from-white last:from-[166px] last:via-white last:to-[#c0b4f5]">
                        <img src="/ipx/index-btn-icon.webp" width="36" height="36" class="absolute right-[6px] top-[6px]"/>
                        <img src="/ipx/download-windows.png" width="48" height="48"/>
                        <h4 class="text-[#22242c] text-[16px] font-medium leading-[22px] mt-[16px] mb-[74px] text-center">Windows 版</h4>
                        <button class="bg-[#22242c] text-[#fff] rounded-[8px] text-[16px] mb-[12px] min-h-[40px] w-[150px]">下载</button>
                    ...
                    <article class="bg-gradient-to-b from-[#eaf8ee] to-[#f6fcf8] rounded-[8px] min-h-[693px] w-[580px]">
                        ...
                        <a class="transition-all duration-300 text-[#22242c] text-[14px] font-medium text-left no-underline">
                            <button class="flex items-center justify-center gap-3 border border-[#22242c] rounded-lg text-[#22242c] text-base font-medium leading-[22px] min-h-14 w-53 ml-82 bg-none text-center">
                                查看详细步骤
                                <img src="/public/ipx/download-button-icon.png" width="24" class="max-w-[100%]"/>
                            </button>
                        </a>
                    </article>
